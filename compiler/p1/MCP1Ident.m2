...
IMPLEMENTATION MODULE MCP1Ident;   (* LG *)
  ...
  FROM MCBase IMPORT noprio, Idptr, Stptr, Idclass, Structform, Varkind,
     ...
     longintptr, longrealptr, modrev, maxcard, xelos, modrev2;
  FROM MCP1IO IMPORT HashIdent, EnterResWord, String14, spix;
  FROM MCBase IMPORT BitsPerWord, onebyte, adc, oneword, realsize,
  ...
  BEGIN
    ...
    *)
    ...
    IF xelos THEN
       EnterConst('NIL', niltypeptr, 0F00000H-1);
    ELSE
