...
(* $T- *)
   ...
   IMPORT SYSTEM, StdIO, FtdIO, MCStop, SysPerror, Storage, SystemTypes,
      MCBase, MCP1Public, MCSymFileDefs, MCP1Reals, MCHalfword, Archive,
      MCTypes, MCBigSet;
  ...
  VAR sy : Symbol;
   ...
   MODULE StringSystem;
      ...
      VAR 
         string   : Bufptr;
         strcount : CARDINAL;
	 errormsg : BOOLEAN;	(* error message printed? *)
         ix       : CARDINAL;
